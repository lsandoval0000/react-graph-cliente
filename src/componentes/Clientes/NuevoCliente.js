...
import { NUEVO_CLIENTE } from '../../mutations/clientesMutations';
...
export default class NuevoCliente extends Component {
    ...
    registrarCliente = (e,crearCliente)=>{
        e.preventDefault();
                ...
                <div className="row justify-content-center">
                    <Mutation mutation={NUEVO_CLIENTE} onCompleted={ ()=> this.props.history.push('/clientes') }>
                        {(crearCliente,{loading,error,data})=>{
                            return (
                                <form className="col-md-8 m-3" onSubmit={ e => this.registrarCliente(e,crearCliente) }>
